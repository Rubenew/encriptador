const inputText = document.getElementById("mensaje-ingresado");
const outputText = document.getElementById("texto-salida");
const encryptBtn = document.getElementById("encriptar");
const decryptBtn = document.getElementById("desencriptar");
